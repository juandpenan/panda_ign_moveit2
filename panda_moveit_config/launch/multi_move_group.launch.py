...
def generate_launch_description():
    ...
    _robot_description_kinematics_yaml = load_yaml(
        moveit_config_package, path.join("config", "multikinematics.yaml")
    )
    ...
    joint_limits = {
        "robot_description_planning": load_yaml(
            moveit_config_package, path.join("config", "multijoint_limits.yaml")
        )
    }
...
#                                  "default_planning_response_adapters/AddRuckigTrajectorySmoothing",
    ...
    moveit_controller_manager_yaml = load_yaml(
        moveit_config_package, path.join("config", "multimoveit_controller_manager.yaml")
    )
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value=["multi_controllers_", ros2_control_command_interface, ".yaml"],
        )
    )
    ...
    nodes = [
        ...
        Node(
            ...
            parameters=[
                ...
                trajectory_execution,
                planning_scene_monitor_parameters,
                moveit_controller_manager_yaml,
                {"use_sim_time": use_sim_time},
            ],
        ),
        # move_servo
...
def generate_declared_arguments() -> List[DeclareLaunchArgument]:
    ...
    return [
        ...
        DeclareLaunchArgument(
            ...
            default_value=path.join("urdf", "multipanda.urdf.xacro"),
